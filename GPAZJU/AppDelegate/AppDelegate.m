...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
	...
	if ([GZUser hasLogin]) {
		[CrashlyticsKit setUserIdentifier:[GZUser currentUser].stuID];
	}
...
- (void)application:(UIApplication *)app didRegisterForRemoteNotificationsWithDeviceToken:(NSData *)deviceToken
{
	...
	[[NSUserDefaults standardUserDefaults] setValue:currentInstallation.deviceToken forKey:@"deviceToken"];
...
{
	if ([GZUser hasLogin]) {
		[[GZUser currentUser] setPushEnabled:NO withBlock:nil];
	}
}
