...
- (void)initBottomMenu
{
    ...
    _ivLine1.backgroundColor = [UIColor colorWithPatternImage:[UIImage imageNamed:@"picker_line.png"]];
    _ivLine2.backgroundColor = [UIColor colorWithPatternImage:[UIImage imageNamed:@"picker_line.png"]];
...
- (CGSize)collectionView:(UICollectionView *)collectionView layout:(UICollectionViewLayout*)collectionViewLayout sizeForItemAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (_nColumnCount > 0) {
        CGFloat x = width / _nColumnCount - 5;
